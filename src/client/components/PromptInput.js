  ...
  return (
    <div className="prompt-input-container">
      <div className="score-display" aria-live="polite">
        ...
        >
          <span className="score-number" style={{ color: getScoreColor(currentScore) }}>
            {currentScore}
          </span>
          <span className="score-percent">%</span>
        </div>
        <div className="score-label" style={{ color: getScoreColor(currentScore) }}>
      ...
      <div className="input-section">
        <div className="input-container">
          ...
          <div id="prompt-help" className="sr-only">
            Enter your prompt and get real-time scoring and suggestions for improvement
          </div>
        </div>
